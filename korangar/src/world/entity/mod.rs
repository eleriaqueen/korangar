...
fn get_sprite_path_for_player_job(job_id: usize) -> &'static str {
    match job_id {
        ...
        4064 => "미케닉",                 // MECHANIC_H
        4065 => "길로틴크로스",           // GUILLOTINE_CROSS_HIGH
        4066 => "가드",                   // ROYAL_GUARD
        4067 => "소서러",                 // SORCERER
        4068 => "민스트럴",               // MINSTREL
        4069 => "원더러",                 // WANDERER
        ...
        4101 => "길로틴크로스",           // GUILLOTINE_CROSS_BABY
        ...
        4146 => "켈베로스어쎄신크로스",   // HYENA_ASSASSIN_CROSS
        ...
        4234 => "권성포링",               // PORING_STAR_GLADIATOR_BABY
